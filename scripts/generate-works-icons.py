...
Run after changing the icon design:
    ...
    python3 scripts/generate-works-icons.py

Writes docs/works/icons/icon-192.png and docs/works/icons/icon-512.png. Pure standard library (zlib + struct),
...
CANVAS = 512.0
SUPERSAMPLE = 3
OUT_DIR = pathlib.Path(__file__).resolve().parent.parent / "docs" / "works" / "icons"
SIZES = (192, 512)

# Palette shared with docs/works/styles.css and android/.../theme/Color.kt.
